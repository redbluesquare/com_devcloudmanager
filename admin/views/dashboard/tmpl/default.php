...
?>
<div class="row-fluid">
	<div class="span3 well" style="text-align:center;height:140px"><a href="<?php echo JRoute::_('index.php?option=com_devcloudmanagert&view=ddcclients'); ?>" ><?php echo JText::_('COM_DEVCLOUDMANAGER_CLIENTS')?></a></div>
